...
public class suppressionDemande_accInt extends HttpServlet {
       ...
       // ------- INSERTION -----
        ...
        try{
           ...
           //message valider
            ...
            response.sendRedirect("admin/dashbord/table demandeur interne accepter.jsp?etat=1");
        
        } catch (Exception e) {
            
           //message erreur
            response.sendRedirect("admin/dashbord/table demandeur interne accepter.jsp?etat=0");
        }
    }
