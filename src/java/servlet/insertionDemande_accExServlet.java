...
public class insertionDemande_accExServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
       ...
       // ------- INSERTION -----
        ...
        String id_eurExt = request.getParameter("id_eurExt");       
      ...
      try{
           ...
           // MESSAGE EMAIL
            ...
            String destinataire = request.getParameter("rec");
        ...
        try {
            ...
            "\n" +
            "Je vous remercie pour l'intérêt que vous portez à notre entreprise et pour avoir postulé pour le poste de [nom du poste].\n" +
            "\n" +
            ...
            try{
            test.insertionTest(type, id_eurExt, bdd);
            session.setAttribute("type", type);
             
            //  message valider     
            request.setAttribute("etat","valider");
            response.sendRedirect("admin/dashbord/table demandeur externe.jsp?etat=1");
            }catch (Exception e) {
                
            //  message erreur
            response.sendRedirect("admin/dashbord/table demandeur externe.jsp?etat=0");
