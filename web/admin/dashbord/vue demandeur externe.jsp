                                          ...
                                          <% while (AllEmpl.next()) { %>
                                            ...
                                            <form class="row g-3 needs-validation" novalidate>
                                                ...
                                                <div class="col-md-4">
                                                   ...
                                                   <div class="input-group has-validation">
                                                      <input type="text" class="form-control" id="validationCustomUsername" name="" aria-describedby="inputGroupPrepend" value="<% out.println(AllEmpl.getString("pseudo_accext")); %>" required>
                                                   </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="validationCustomUsername" class="form-label">Mot de passe</label>
                                                   <div class="input-group has-validation">
                                                      <input type="text" class="form-control" id="validationCustomUsername" name="" aria-describedby="inputGroupPrepend" value="<% out.println(AllEmpl.getString("mdp_accext")); %>" required>
                                                   </div>
                                                </div>
                                                <div class="col-lg-12">
