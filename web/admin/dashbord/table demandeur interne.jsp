...
<%
   ...
   ResultSet AllIntertest = demandeurInt.getDemandeurInterneTest(con); 
                        ...
                        <div class="row column_title">
                           <div class="col-md-12">
                              <div class="page_title">
                                 <h2>Liste demandeurs internes </h2> 
                              </div>
                           </div>
                        </div>  
                              ...
                              <tr>
                                 ...
                                 <td class="row btn-action">
                                   ...
                                   <img          
                                    ...
                                    <% if(demandeurInt.getTestById(AllInter.getInt("id_eurInt"), con).compareTo("")==0){  %>
                                    ...
                                    <img 
                                            ...
                                            data-bs-recipient="<% out.println(AllInter.getString("email_visit")); %>"
                                            data-bs-id="<% out.println(AllInter.getString("id_eurInt")); %>"  
                                            data-bs-nosMet="<% out.println(AllInter.getString("nom_nosMet")); %>"
                                            class="btn-accept1">
                                    <% } %>            
                                    <%-- acceptation --%>
                                              ...
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                  <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="recipient" value="<% out.println(AllInter.getString("email_visit")); %>" id="recipient-name">
                                                    <input type="hidden" class="id form-control" name="nosMet" value="" id="recipient-name">
                                                    
                                                    <input type="hidden" class="nosMet form-control" name="nosMet" value="<% out.println(AllInter.getString("nom_nosMet")); %>" id="recipient-name">
                                                  </div>
                                                  <div class="mb-3">
                                                ...
                                                <div class="modal-footer">
                                                  ...
                                                  <button type="button" 
                                                          ...
                                                          data-bs-toggle="modal"
                                                          data_1 ="<% out.println(AllInter.getString("id_eurInt")); %>"
                                                          data-bs="<% out.println(AllInter.getString("nom_nosMet")); %>"  
                                        ...
                                        <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                         <h4 class="modal-title" id="exampleModalLabel">Êtes-vous sûr d'envoyer ce message avec la date du test d'embauche à son email?</h4>
                                                        <input type="hidden" class="id2 form-control" name="id" value="<% out.println(AllInter.getString("id_eurInt")); %>" id="id2">
                                   ...
                                   <form method="post" action="../../insertionDemande_refIn" >
                                       <img      
                                        ...
                                        class="btn-supprimer"
                                        prend_id ="<% out.println(AllInter.getString("id_eurInt")); %>"
                                        >
                                        ...
                                        <div class="modal-dialog">
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="hidden" value="<% out.println(AllInter.getString("id_eurInt")); %>" class="id form-control" name="id" id="exampleFormControlInput1" >
                                                <div class="mt-4" style="display: flex;column-gaprow-gap: 4px;justify-content: end;column-gap: 22px;">
                                                    <div class="accept">
                                ...
                                <td style="vertical-align: middle;">
                                    <% out.println(demandeurInt.getTestById(AllInter.getInt("id_eurInt"), con)); %>
                                </td>
