...
<%
    ...
    ResultSet AllIdObjet = Objet_demandeI.getIdObjet_demandei(request.getParameter("id"),con);
                              ...
                              <div class="dash_blog_inner">
                                    ...
                                    <div class="col-md-12">
                                       <div class="card-body">
                                          ...
                                          <% while (AllIdObjet.next()) { %>
                                        
                                            <form class="job" method="post" action="../../../Objet_de_la_demande">
                                                <input type="text" class="form-control" id="validationCustom01" name="id_Objet" value="<% out.println(AllIdObjet.getString("id_objetDemI")); %>" style="display: none;" required>
                                               
                                                    <div class="mb-3">
                                                        <label  class="form-label">Modification objet de la demande</label>
                                                        <input type="text" class="form-control col-md-8"  name="objet_demandeI" value="<% out.println(AllIdObjet.getString("objet_demandeI")); %>" required>
                                                    </div>
