...
<%
    ...
    ResultSet AllIdtypeDeContrat = typeContrat.getAIdTypeContrat(request.getParameter("id"),con);
                        ...
                        <div class="row column_title">
                           <div class="col-md-12">
                              <div class="page_title">
                                 <h2>Modification type de contrat</h2>
                              </div>
                           </div>
                        </div>
                        <div class="col-md-12">
                           <div class="dash_blog">
                              <div class="dash_blog_inner">
                                    <div class="dash_head">
                                       <h3><span><i class="fa fa-edit"></i> Modification type de contrat</span></h3>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                       <div class="card-body">
                                          ...
                                          <% while (AllIdtypeDeContrat.next()) { %>
                                        
                                            <form class="job" method="post" action="../../../type_contrat">
                                                <input type="text" class="form-control" id="validationCustom01" name="id_typeCon" value="<% out.println(AllIdtypeDeContrat.getString("id_typeContra")); %>" style="display: none;" required>
                                               
                                                <div class="mb-3">
                                                    <label  class="form-label">Modification type de contrat</label>
                                                    <input type="text" class="form-control"  name="ajout_typeCont" value="<% out.println(AllIdtypeDeContrat.getString("type_Contrat")); %>" required>
                                                </div>
