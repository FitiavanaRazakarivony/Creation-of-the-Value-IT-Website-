...
<%
    ...
    ResultSet AllIdNosMet = nosmetier.getIdMetier(request.getParameter("id"),con);
                        ...
                        <div class="row column_title">
                           <div class="col-md-12">
                              <div class="page_title">
                                 <h2>Modification objet de la demande</h2>
                              </div>
                           </div>
                        </div>
                        <div class="col-md-12">
                           <div class="dash_blog">
                              <div class="dash_blog_inner">
                                    <div class="dash_head">
                                       <h3><span><i class="fa fa-edit"></i> Modification objet de la demande</span></h3>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                       <div class="card-body">
                                          ...
                                          <% while (AllIdNosMet.next()) { %>
                                        
                                            <form class="job" method="post" action="../../../nos_metier" >
                                                <input type="text" class="form-control" id="validationCustom01" name="id_nosMet" value="<% out.println(AllIdNosMet.getString("id_nosMet")); %>" style="display: none;" required>
                                               
                                                    <div class="mb-3">
                                                        <input class=" form-control chps" type="text" name="nom_nosMet" value="<% out.println(AllIdNosMet.getString("nom_nosMet")); %>" required/>
                                                    </div>

                                                    <div class="form-group mb-3 ">
                                                        <label for="exampleFormControlInput1" class="form-label">Description de metiers</label>
                                                        <textarea class="form-control" id="exampleFormControlTextarea1" value="<% out.println(AllIdNosMet.getString("description_nosMet")); %>" rows="3" name="desc_nosMet"  required ><% out.println(AllIdNosMet.getString("description_nosMet")); %></textarea>
                                                    </div>
