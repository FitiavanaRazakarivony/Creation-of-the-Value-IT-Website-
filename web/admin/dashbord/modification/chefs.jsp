...
<%
    ...
    ResultSet AllIdChef = chef.getIdChef(request.getParameter("id"),con);
                        ...
                        <div class="col-md-12">
                           <div class="dash_blog">
                              <div class="dash_blog_inner">
                                    <div class="dash_head">
                                       <h3><span><i class="fa fa-edit"></i> Modification chefs</span></h3>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                       <div class="card-body">
                                          ...
                                          <% while (AllIdChef.next()) { %>
                                        
                                            <form class="job" method="post" action="../../../chefs"  enctype="multipart/form-data" >
                                                <input type="text" class="form-control" id="validationCustom01" name="id_lead" value="<% out.println(AllIdChef.getString("id_lead")); %>" style="display: none;" required>
                                               
                                                <div class="user_profle_side">
                                                    <div class="user_img"><img class="img-responsive" src="../../../image/<% out.println(AllIdChef.getString("imageLead")); %>" alt="#" /></div>
                                                </div>
                                                ...
                                                <label  for="validationCustom04" class="form-label">Metier : <% out.println(AllIdChef.getString("nom_nosMet")); %></label>
                                                ...
                                                <input class="form-control" type="text" name="nomChef" value="<% out.println(AllIdChef.getString("nomLead")); %>">    
                                                </div>

                                                <div class="mb-3">
                                                    <label for="exampleFormControlInput1" class="form-label">Prenom</label>
                                                    <input class="form-control" type="text" name="prenomChef" value="<% out.println(AllIdChef.getString("prenomLead")); %>">    
                                                </div>
