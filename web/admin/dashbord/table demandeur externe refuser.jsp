...
<%
   ...
   ResultSet AllEmpl = demande_refEx.getDemandeurRefExt(con);   
      ...
      <div class="full_container">
                        ...
                        <div class="row column_title">
                           <div class="col-md-12">
                              <div class="page_title">
                                 <h2>Liste demandeurs externes en refuser</h2> 
                              </div>
                           </div>
                        </div>  
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td class="row" style="vertical-align: middle;">
                                    ...
                                    <form method="post" action="../../insertionRetourDemande_refaccExServlet" >
                                        
                                        <button type="button"
                                                class="btn btn-success"
                                                data-bs-toggle="modal" 
                                                data-bs-target="#btnAccept"
                                                prend_id ="<% out.println(AllEmpl.getString("id_teste")); %>"
                                                prend_email ="<% out.println(AllEmpl.getString("email_eurExt")); %>"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-body">
                                                      <input type="hidden" class="id form-control" name="id" id="recipient-name">
                                                      <input type="text" class="email form-control"  id="recipient-name">

                                                    <div class="mb-3">
                                                        <label for="date-input" class="col-form-label">Pseudo</label>
                                                        <input type="text" class="form-control" id="date-input" name="Pseudo">
                                                    </div>
                                                    <div class="mb-3">
                                                      <label for="time-input" class="col-form-label">Mot de passe</label>
                                                      <input type="text" class="form-control" id="time-input" name="mdp">
                                                    </div>
                                                        <hr>
                                                    <h4 class="modal-title" id="exampleModalLabel">êtes vous sûr de retourner cette employer ?</h4>
                                                        <hr>
        ...
        <script>
            ...
            exampleModal.addEventListener('show.bs.modal', function (event) {
              ...
              var recipient = button.getAttribute('prend_id')
                var prend_email = button.getAttribute('prend_email')    
                var modalBodyPrend_email = exampleModal.querySelector('.modal-body .email')

                
              var modalTitle = exampleModal.querySelector('.modal-title')
              var modalBodyInput = exampleModal.querySelector('.modal-body input')

              modalTitle.textContent = 'Validation ' 
              modalBodyInput.value = recipient 
              modalBodyPrend_email.value = prend_email
