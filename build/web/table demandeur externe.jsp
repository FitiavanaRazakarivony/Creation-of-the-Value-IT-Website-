                              ...
                              <tr>
                                 ...
                                 <td class="row" style="vertical-align: middle;">
                                    ...
                                    <form method="post" action="../../insertionDemande_accEx" >
                                        <input type="hidden" value="<% out.println(AllEmpl.getString("id_eurExt")); %>" class="form-control" name="id_eurExt" id="exampleFormControlInput1" >
