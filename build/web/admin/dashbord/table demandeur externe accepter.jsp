...
<%
   ...
   ResultSet AllEmpl = demande_accExt.afficherDeman_accEx(con);   
                        ...
                        <div class="row column_title">
                           <div class="col-md-12">
                              <div class="page_title">
                                 <h2>Liste demandeurs externes acceptées</h2> 
                              </div>
                           </div>
                        </div>  
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td class="row" style="vertical-align: middle;">
                                    ...
                                    <a href="vue demandeur externe.jsp?id_eurExt=<% out.println(AllEmpl.getString("id_eurExt")); %>">
                                       <img 
                                           title="Voir"
                                        ...
                                        <form method="post" action="../../suppressionExtAccpter" >
                                            <img    
                                          ...
                                          <div class="modal-dialog">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <h4 class="modal-title" id="exampleModalLabel">étes vous sûr de supprimer ?</h4>
