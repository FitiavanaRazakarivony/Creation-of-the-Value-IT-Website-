...
<%
    ...
    ResultSet getAllTrav = demandeurInt.getIdDemandeurInterne(request.getParameter("id"),con);
                        ...
                        <div class="row column_title">
                           <div class="col-md-12">
                              <div class="page_title">
                                 <h2>Voir le demandeur interne</h2>
                              </div>
                           </div>
                        </div>
                        <div class="col-md-12">
                           <div class="dash_blog">
                              <div class="dash_blog_inner">
                                    <div class="dash_head">
                                       <h3><span><i class="fa fa-edit"></i> Demandeur interne</span></h3>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                       <div class="card-body">
                                          ...
                                          <% while (getAllTrav.next()) { %>
                                          
                                            <form class="row g-3 needs-validation" novalidate>
                                                <input type="text" class="form-control" id="validationCustom01" name="id" value="<% out.println(getAllTrav.getString("id_eurInt")); %>" style="display: none;" required>
                                                <div class="col mt-4">
                                                    <div class="col-md-4 mt-4">
                                                       <label for="validationCustom02" class="form-label">Date de la demande</label>
                                                       <input type="text" class="form-control" id="validationCustom02" name="tel_empl" value="<% out.println(getAllTrav.getString("date_demI")); %>" required>
                                                    </div>
                                                    <div class="row mt-4">
                                                        <div class="col-md-4 mt-4">
                                                            <label for="validationCustom02" class="form-label">Pseudo</label>
                                                            <input type="text" class="form-control" id="validationCustom02" name="tel_empl" value="<% out.println(getAllTrav.getString("pseudo_visit")); %>" required>
                                                        </div>
                                                        <div class="col-md-4 mt-4">
                                                            <label for="validationCustom02" class="form-label">Mot de passe</label>
                                                            <input type="text" class="form-control" id="validationCustom02" name="tel_empl" value="<% out.println(getAllTrav.getString("motdepass_visit")); %>" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                   ...
                                                   <div class="col-sm-4 col-md-3 margin_bottom_30">
                                                      <div class="column">
                                                        <label for="validationCustom01" class="form-label">Voici le CV : </label>
                                                         ...
                                                         <a data-fancybox="gallery" href="../../cv interne/<% out.println(getAllTrav.getString("CV_eurInt")); %>">
                                                         <img class="img-responsive" src="../../cv interne/<% out.println(getAllTrav.getString("CV_eurInt")); %>" alt="#" /></a>
                                                      </div>
                                                ...
                                                <div class="col-md-6 mt-4">
                                                    ...
                                                    <input type="text" class="form-control" id="validationCustom01" name="nom_empl" value="<% out.println(getAllTrav.getString("nom_visit")); %>" required>
                                                </div>
                                                <div class="col-md-6 mt-4">
                                                   <label for="validationCustom02" class="form-label">Prenom</label>
                                                   <input type="text" class="form-control" id="validationCustom02" name="prenom_empl"  value="<% out.println(getAllTrav.getString("prenom_visit")); %>" required>
                                                </div>
                                                <div class="col-md-4 mt-4">
                                                   <label for="validationCustom02" class="form-label">tel</label>
                                                   <input type="text" class="form-control" id="validationCustom02" name="tel_empl" value="<% out.println(getAllTrav.getString("tel_visit")); %>" required>
                                                </div>
                                                ...
                                                <div class="col-md-4 mt-4">
                                                   ...
                                                   <div class="input-group has-validation">
                                                      ...
                                                      <input type="mail" class="form-control" id="validationCustomUsername" name="email_empl" aria-describedby="inputGroupPrepend" value="<% out.println(getAllTrav.getString("email_visit")); %>" required>
                                                   </div>
                                                </div>
                                                <div class="col-md-4 mt-4">
                                                   <label for="validationCustom03" class="form-label">adresse</label>
                                                   <input type="text" class="form-control" id="validationCustom03"   name="adress_empl"  value="<% out.println(getAllTrav.getString("adress_visit")); %>" required>
                                                </div>
                                                <div class="col-md-4 mt-4">
                                                   <label  for="validationCustom04" class="form-label">sexe : <% out.println(getAllTrav.getString("sexe")); %></label>
                                                   <select name="id_sexe" class="form-select col-md-6" id="validationCustom04" style="margin-top: 1.3rem;height: 3rem;" aria-label="Default select example" required>
                                                      <option selected disabled value="<% out.println(getAllTrav.getString("sexe")); %>">Choisir...</option>
                                                      <option>
                                                      <% while (AllSex.next()) { %>
                                                ...
                                                <div class="col-md-6 mt-4">
                                                   <label  for="validationCustom04" class="form-label">metier : <% out.println(getAllTrav.getString("nom_nosMet")); %></label>
                                                   <select name="id_nosMet" class="form-select col-md-6" id="validationCustom04" style="margin-top: 1.3rem;height: 3rem;" aria-label="Default select example"  required>
                                                      <option selected disabled value="<% out.println(getAllTrav.getString("nom_nosMet")); %>">Choisir...</option>
                                                      <option>
                                                         <% while (resann.next()) { %>
                                                ...
                                                <div class="col-md-12 mt-4">
                                                   ...
                                                   <textarea type="text" class="form-control" id="validationCustom03"   name="adress_empl"  value="<% out.println(getAllTrav.getString("annonce")); %>" required><% out.println(getAllTrav.getString("annonce")); %></textarea>
                                                </div>
                                                
                                                <div class="col-md-6 mt-4">
                                                   <label for="validationCustomUsername" class="form-label">Objet de la demande</label>
                                                   <div class="input-group has-validation">
                                                      <input type="text" class="form-control" id="validationCustomUsername" name="objet_demex" aria-describedby="inputGroupPrepend" value="<% out.println(getAllTrav.getString("objet_demandeI")); %>" required>
                                                   </div>
                                                </div>
                                                <div class="col-md-6 mt-4">
                                                   <label for="validationCustomUsername" class="form-label">contenu de la demande </label>
                                                   <div class="input-group has-validation">
                                                      <input type="text" class="form-control" id="validationCustomUsername" name="objet_demex" aria-describedby="inputGroupPrepend" value="<% out.println(getAllTrav.getString("contenu_demI")); %>" required>
                                                   </div>
                                                </div>
