...
<%
    ...
    ResultSet AllIdCompet = comptence.IdCompetence_nosMet(request.getParameter("id"),con);
                        ...
                        <div class="col-md-12">
                           <div class="dash_blog">
                              <div class="dash_blog_inner">
                                    <div class="dash_head">
                                       <h3><span><i class="fa fa-edit"></i> Modification competence</span></h3>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                       <div class="card-body">
                                          ...
                                          <% while (AllIdCompet.next()) { %>
                                        
                                            <form class="job" method="post" action="../../../competence">
                                                
                                                <input type="text" class="form-control" id="validationCustom01" name="id_compet" value="<% out.println(AllIdCompet.getString("id_compet")); %>" style="display: none;" required>
                                               
                                                <div class="mb-3">
                                                    <label for="exampleFormControlInput1" class="form-label"> Choisissez le metier </label>
                                                    
                                                    <input type="text" class="form-control" value="<% out.println(AllIdCompet.getString("nom_nosMet")); %>" disabled >
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="compt" value="<% out.println(AllIdCompet.getString("competence")); %>" required>
                                                </div>
