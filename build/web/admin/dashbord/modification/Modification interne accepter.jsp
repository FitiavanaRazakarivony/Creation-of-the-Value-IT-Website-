...
<%
    ...
    ResultSet AllIdVisiteur = demandeurInt.getDemandeurInterne1Acc(request.getParameter("id"),con); 
    
    int id = Integer.parseInt(request.getParameter("id"));
    demandeurInt.createView(id, con);
                        ...
                        <div class="row column_title">
                           <div class="col-md-12">
                              <div class="page_title">
                                 <h2>Modification demandeur interne accepeter</h2>
                              </div>
                           </div>
                        </div>
                        <div class="col-md-12">
                           <div class="dash_blog">
                              <div class="dash_blog_inner">
                                    <div class="dash_head">
                                       <h3><span><i class="fa fa-edit"></i> Modification demandeur interne accepter</span></h3>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                       <div class="card-body">
                                          <%-- example --%>
                                              <form action="../../../interne_accept" method="POST">
                                           <% while (AllIdVisiteur.next()) { %> 
                                          
                                        
                                                <input type="hidden" class="form-control" id="validationCustom01" name="id" value="<% out.print(AllIdVisiteur.getString("id_testeInter")); %>"  required>
                                                <input type="hidden" class="form-control" id="validationCustom01" name="id_eurInt" value="<% out.print(AllIdVisiteur.getString("id_eurInt")); %>"  required>

                                                
                                                <div class="col">
                                                    <div class="col-md-4 mt-4">
                                                        <label for="validationCustom02" class="form-label">Date de la demande</label>
                                                        <input type="text" class="form-control" id="validationCustom02" name="date" value="<% out.println(AllIdVisiteur.getString("date_demI")); %>" required disabled>
                                                    </div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-4 mt-4">
                                                        <label for="validationCustom02" class="form-label">Observation</label>
                                                        <input type="text" class="form-control" id="validationCustom02" name="date" value="<% out.println(AllIdVisiteur.getString("testeInter")); %>" disabled>
                                                    </div>
                                                </div>
                                                   ...
                                                   <div class="col-sm-4 col-md-3 margin_bottom_30">
                                                      <div class="column">
                                                        <label for="validationCustom01" class="form-label">Voici le CV : </label>
                                                         <a data-fancybox="gallery" href="../../../cv interne/<% out.println(AllIdVisiteur.getString("CV_eurInt")); %>">
                                                         <img class="img-responsive" src="../../../cv interne/<% out.println(AllIdVisiteur.getString("CV_eurInt")); %>" alt="#" /></a>
                                                      </div>
                                                ...
                                                <div class="col-md-4 mt-4">
                                                   <label  for="validationCustom04" class="form-label">sexe :
                                                       <input type="text" class="form-control" id="validationCustom03"   name=""  value="<% out.println(AllIdVisiteur.getString("sexe")); %>" disabled="">
                                                    </label>
                                                ...
                                                <div class="col-md-6 mt-4">
                                                   ...
                                                   <select name="id_nosMet" class="form-select col-md-6 bg-select" id="validationCustom04" style="margin-top: 1.3rem;height: 3rem;" aria-label="Default select example"  required>
                                                      ...
                                                      <option>
                                                         <% while (resann.next()) { %>
                                                            <option value="<% out.print(resann.getString("id_nosMet")); %>">
