...
<%
   ...
   ResultSet AllEmpl = demande_refInt.getIdDemandeurRefInterne(con);   
   ResultSet IdExt = demandeurExt.getDemandeurExterne(con); 
                        ...
                        <div class="row column_title">
                           <div class="col-md-12">
                              <div class="page_title">
                                 <h2>Liste demandeurs internes refusées</h2> 
                              </div>
                           </div>
                        </div>  
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td style="vertical-align: middle;">
                                    <% out.println(AllEmpl.getString("nom_visit")); %>
                                 </td>
                                 <td style="vertical-align: middle;">
                                    <% out.println(AllEmpl.getString("prenom_visit")); %>
                                 </td>
                                 <td style="vertical-align: middle;">
                                    <% out.println(AllEmpl.getString("email_visit")); %>
                                 </td>
                                 <td style="vertical-align: middle;">                               
                                 ...
                                 <td class="row" style="vertical-align: middle;">
                                    ...
                                    <form method="post" action="../../insertionRetourDemande_accExServlet" >
                                        <input
                                            title="Accepter"
                                            style="width: 6rem;"
                                            ...
                                            prend_id ="<% out.println(AllEmpl.getString("id_testeInter")); %>">
                                            ...
                                            <div class="modal-dialog">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <input type="hidden" class="id form-control" name="id" value="<% out.println (AllEmpl.getString("id_testeInter")); %>" id="recipient-name">
