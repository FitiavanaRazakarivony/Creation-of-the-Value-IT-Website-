                                            ...
                                            <form class="row g-3 needs-validation" enctype="multipart/form-data" novalidate>
                                                   ...
                                                   <div class="col-sm-4 col-md-3 margin_bottom_30">
                                                      <div class="column">
                                                        <label for="validationCustom01" class="form-label">Voici le CV : </label>
                                                         ...
                                                         <a data-fancybox="gallery" href="../../cv/<% out.println(getAllTrav.getString("CV_eurInt")); %>">
                                                ...
                                                <div class="col-md-4">
                                                   ...
                                                   <div class="input-group has-validation">
                                                      ...
                                                      <input type="text" class="form-control" id="validationCustomUsername" name="email_empl" aria-describedby="inputGroupPrepend" value="<% out.println(getAllTrav.getString("email_visit")); %>" required>
                                                      <div class="valid-feedback">
                                                      OK !
                                                      </div>
                                                      <div class="invalid-feedback">
                                                ...
                                                <div class="col-md-10 mt-4">
                                                   ...
                                                   Vérifier le a adresse.
                                                    ...
                                                    <div class="read_more">
                                                       <div class="btn">
                                                           <a href="table demandeur interne.jsp" class="btn btn-success " type="submit" >OK</a>
                                                       </div>
                                                    </div>
